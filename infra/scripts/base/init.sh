...
while sudo apt install openjdk-17-jdk unzip htop vim curl jq --yes; [[ $? -ne 0 ]];
do
...
mkdir /home/ubuntu/druid/conf/druid/cluster/historical
mkdir /home/ubuntu/druid/conf/druid/cluster/historical/historical
...
cat <<EOL > /home/ubuntu/druid/conf/supervise/cluster/data.conf
:verify bin/verify-java

middleManager bin/run-druid middleManager conf/druid/cluster/data
EOL

cat <<EOL > /home/ubuntu/druid/conf/supervise/cluster/historical.conf
:verify bin/verify-java

historical bin/run-druid historical conf/druid/cluster/historical
EOL

cat <<EOL > /home/ubuntu/druid/bin/start-cluster-historical-server
PWD="\$(pwd)"
WHEREAMI="\$(dirname "\$0")"
...
chmod 744 /home/ubuntu/druid/conf/supervise/cluster/historical.conf
chmod 744 /home/ubuntu/druid/conf/supervise/cluster/data.conf
chmod 744 /home/ubuntu/druid/bin/start-cluster-historical-server

echo "${base_common}" > /home/ubuntu/druid/conf/druid/cluster/_common/common.runtime.properties
